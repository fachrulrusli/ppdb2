...
@section('content-child')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(array('id' => 'grup-akses','role'=>'form','class'=>'form-horizontal form-row-seperated')) !!}
            <div class="form-body">
                <!-- BEGIN FORM-->
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('akses', 'Permission:', ['class' => 'control-label']) !!}
...
@section('script-onpage')
    <script type="application/javascript">
        $(document).ready(function () {
            var multi = $('#grup-akses').bootstrapDualListbox({
            ...
            $('#btnSubmit').click(function (e) {
                ...
                bootbox.confirm("{{trans('message.submit_confirm')}}", function (result) {
                    if (result) {
                        $.ajax({
                            url: "{{route('post-group-akses')}}",
                            data: $('#grup-akses').serialize(),
                            statusCode: {
                                201: function (data) {
