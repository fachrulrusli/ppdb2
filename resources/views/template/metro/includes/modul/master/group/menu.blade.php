...
@section('content-child')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(array('id' => 'grup-menu','role'=>'form','class'=>'form-horizontal form-row-seperated')) !!}
            <div class="form-body">
                <!-- BEGIN FORM-->
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('menu[]', $menu,isset($data) ? $data : '',['class' => 'form-control multi-perm','style="width: 100%;"','multiple']) !!}
                        </div>
                    </div>
                </div>
...
@section('script-onpage')
    <script type="application/javascript">
        $(document).ready(function () {
            var multi = $('#grup-menu').bootstrapDualListbox({
            ...
            $('#btnSubmit').click(function (e) {
                ...
                bootbox.confirm("{{trans('message.submit_confirm')}}", function (result) {
                    if (result) {
                        $.ajax({
                            url: "{{route('post-group-menu')}}",
                            data: $('#grup-menu').serialize(),
                            statusCode: {
                                201: function (data) {
