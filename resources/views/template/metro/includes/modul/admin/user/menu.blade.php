...
@section('content-child')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open(array('id' => 'user-menu','role'=>'form','class'=>'form-horizontal form-row-seperated')) !!}
            <div class="form-body">
                <!-- BEGIN FORM-->
                <div class="row">
                    <div class="col-md-12">
...
@section('script-onpage')
    <script type="application/javascript">
        $(document).ready(function () {
            var multi = $('#user-menu').bootstrapDualListbox({
            ...
            $('#btnSubmit').click(function (e) {
                ...
                bootbox.confirm("{{trans('message.submit_confirm')}}", function (result) {
                    if (result) {
                        $.ajax({
                            url: "{{route('post-user-menu')}}",
                            data: $('#user-menu').serialize(),
                            statusCode: {
                                201: function (data) {
