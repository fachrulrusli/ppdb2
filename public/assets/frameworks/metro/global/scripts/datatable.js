...
var Datatable = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            the = this;
            document.getElementById("tbl_data").deleteTFoot(); // delete footer
            $("#tbl_data").append(

                $('<tfoot/>').append($("#tbl_data thead tr").clone())
            );
            // default settings
            options = $.extend(true, {
                src: "", // actual table
                ...
                dataTable: {
                    "dom": '<"toolbar"><"top"f<"clear">>rt<"bottom"<"row"<"col-sm-5"i><"col-sm-7 "p>><"clear">>',
