...
class PengingatAbsenPulang2 extends Command
{
   protected $signature = 'pengingatabsencabang:day';
     ...
     * @var string
     */
    protected $description = 'Notif Pengingat Absen Pulang Cabang';
    ...
    public function handle()
    {
        ...
        $stmt1 = "SELECT DISTINCT x.nik,x.nama, x.kdshift,c.batas_pulang, CONVERT(TIME,DATEADD(MINUTE, -10, c.batas_pulang)) as sendtime, z.hp 
                    ...
                    WHERE x.kdshift = '2' AND hp is not null
                ";
